                                ...
                                <div className="social-media-items pb-5">
                                    <div className="social-media-title">
                                        ...
                                        <div className="social-media-icons">
                                            <div className="social-media-icon fs-2 text-light"><FaFacebook/></div>
                                            <div className="social-media-icon fs-2 text-light ps-5"><FaInstagram/></div>
                                            <div className="social-media-icon fs-2 text-light ps-5"><FaTwitter/></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
